...
API_ID = int(os.environ.get("API_ID", "36114630"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "eb058bb41fdd880a6aa81a5050025b69")
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "5201406424")

# Your Mongodb Database Url
# Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_URI = os.environ.get("DB_URI", "mongodb+srv://lol327970_db_user:x9KiZhZdVB3Axc0w@cluster0.y4rgcar.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
